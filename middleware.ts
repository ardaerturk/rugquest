...
export default async function middleware(req: NextRequest) {
  ...
  if (
    ...
    req.nextUrl.pathname.startsWith("/api/og") || // Use startsWith for /api/og/*
    req.nextUrl.pathname.startsWith("/api/webhook") || // Use startsWith for /api/webhook/*
    req.nextUrl.pathname === "/api/turn" // Exclude /api/turn
  ) {
